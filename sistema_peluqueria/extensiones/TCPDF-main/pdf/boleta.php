...
$bloque1 = <<<EOF
	...
	<table>
		...
		<tr>
			...
			<td style="width:150px"><img src="centro.PNG"></td>
...
$bloque3 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<td style="border: 1px solid #666; background-color:#5D6D7E; color:white; width:30%; text-align:center"><b>PRECIO</b></td>
		<td style="border: 1px solid #666; background-color:#5D6D7E; color:white; width:15%; text-align:center"><b>TOTAL</b></td>
		</tr>
