...
$html .= '<table border="1" cellpadding="5" cellspacing="0" style="border-collapse:collapse; width:100%; font-size:10px;">
    <thead>
        <tr style="background-color:#e9967a; color:white;">
            <th style="width:60%; text-align:center; font-weight:bold; padding:5px;">Nombre</th>
...
foreach ($respuesta as $index => $servicios) {
    ...
    $html .= '<tr style="background-color: ' . $bgColor . ';">
        <td style="width:60%; text-align:center; padding:5px;">' . $servicios['nombre'] . '</td>
        <td style="width:20%; text-align:center; padding:5px;">' . $servicios['precio'] . '</td>
