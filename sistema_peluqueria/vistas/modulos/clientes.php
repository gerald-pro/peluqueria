    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>
                    <div class="text-#17202A" style="width:98%; margin-left:2%;margin-top:2%;">ADMINISTRAR
                        CLIENTES</div>
                </h3>
            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <table id="Datatable" class="table table-striped table-bordered responsive tablas"
                                        ...
                                        <thead
                                            style="text-align:center; background-color:#D6CCCB; font-size:16px; color:#17202A;">
                                  ...
                                  <td style="text-align:center">
                                    ...
                                    <div class="btn-group">
                                      ...
                                      <button class="btn btn-sm btn-danger btnEliminarCliente" idCliente="' . $value["idcliente"] . '"  style="width:90%; margin-left:1%"><i class="fa fa-trash"></i></button>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control input-lg" name="editardomicilioP"
                                    id="editardomicilioP" required>
