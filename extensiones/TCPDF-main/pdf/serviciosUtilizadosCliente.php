...
// Configuraciones de márgenes y salto de página automático
$pdf->SetMargins(10, 50, 10);
$pdf->SetHeaderMargin(10);
$pdf->SetFooterMargin(15);
$pdf->SetAutoPageBreak(TRUE, 15); // Activar el salto de página automático
...
// Consultar datos de los servicios
...
foreach ($respuesta as $index => $servicios) {
    ...
    // Comprobar si se requiere una nueva página
    if (($index + 1) % 20 == 0) { // cada 20 filas, puede ajustarse según el tamaño de página
        $html .= '</tbody></table>';  // Cierra la tabla actual
...
$html .= '</tbody></table>'; // Cerrar la tabla final

// Escribir la tabla final en el PDF
