...
$bloque1 = <<<EOF
	...
	<table>
		...
		<tr>
			...
			<td style="width:150px"><img src="images/romeroLOGO.png"></td>
			...
			<td style="background-color:white; width:160px">
				...
				<div style="font-size:12px; text-align:left; line-height:15px;">
					...
					<b>NIT:</b> 678934013
					<br>
					<b>Contacto:</b> 3 3227281
					<br>
					<b>Dirección:</b> Zona<br>Los Lotes - Av. Bolivia
...
$bloque2 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<i><b>Nombres Ap.Paterno Ap.Materno</b></i>
			</td>
...
$bloque3 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<td style="border: 1px solid #666; background-color:#5D6D7E; color:white; width:40%; text-align:center"><b>SERVICIO</b></td>
		<td style="border: 1px solid #666; background-color:#5D6D7E; color:white; width:15%; text-align:center"><b>CANTIDAD</b></td>
		<td style="border: 1px solid #666; background-color:#5D6D7E; color:white; width:30%; text-align:center"><b>PRECIO SERVICIO</b></td>
		<td style="border: 1px solid #666; background-color:#5D6D7E; color:white; width:15%; text-align:center"><b>SUB TOTAL</b></td>
...
$bloque5 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="border: 1px solid #666; background-color:#5D6D7E; color:white; width:100px; text-align:center">
			<b>TOTAL</b>:
			</td>
