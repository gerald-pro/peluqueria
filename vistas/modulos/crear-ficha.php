    ...
    <script>
        ...
        var calendar = $('#calendar').fullCalendar({
          ...
          events: [
            ...
            foreach ($citastrabajador as $key => $value) {
              $color = $value['estado'] == 1 ? '#e4bdb4' : '#cdcdcd';
            ?> {
      ...
      function eliminarCita(id) {
        ...
        swal({
          ...
          confirmButtonText: 'Sí, inactivar cita!'
        }).then(function(result) {
          if (result.value) {
            //alert(usuario);
            window.location = "index.php?ruta=fichas&accion=inactivar&idficha=" + idCita;
          }
        });
      }
    </script>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <select class="form-control select2" id="seleccionarServicio" name="seleccionarServicio" required>
